...
import { 
  FiArrowLeft, FiCheckCircle, FiAlertCircle, FiTarget, FiChevronDown,
...
interface ChapterModePageProps {
  chapterId: string
  chapterSlug: string
  chapterTitle: string
}

export function ChapterModePage({ chapterId, chapterSlug, chapterTitle }: ChapterModePageProps) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-400">Loading Chapter Mode...</p>
        </div>
      </div>
    )
  }
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 flex items-center justify-center p-4">
        <div className="text-center">
          <div className="w-20 h-20 bg-red-500/20 rounded-3xl flex items-center justify-center mx-auto mb-4 border border-red-500/30">
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <p className="text-slate-400 mb-4">No questions available for this chapter yet.</p>
          <Link 
            href={`/dashboard/chapters/${chapterSlug}`} 
            className="inline-flex items-center gap-2 px-6 py-3 bg-emerald-500 text-white font-semibold rounded-xl hover:bg-emerald-600 transition-colors"
          >
        ...
        <div className="px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-sm text-slate-400">Chapter Mode - Study & Learn</p>
            </div>
          </div>
        </div>
      </header>
