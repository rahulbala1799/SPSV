...
export default function IndustryPart2Page() {
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            ...
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-gray-900">{chapter.duration || 30}</p>
          ...
          <ChapterModeButton chapterSlug="industry-part2" />
