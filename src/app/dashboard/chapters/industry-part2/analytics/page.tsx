...
const CHAPTER_ID = 'chapter_industry_part2'
const CHAPTER_PATH = 'industry-part2'
const CHAPTER_TITLE = 'Industry Knowledge - Part 2'
...
export default function IndustryPart2AnalyticsPage() {
