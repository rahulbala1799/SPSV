...
export default function SouthsideFullAnalyticsPage() {
  ...
  const loadAnalytics = async () => {
    try {
      const response = await fetch('/api/analytics/chapter/chapter_hospitals')
      const data = await response.json()
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/dashboard/chapters/hospitals" className="text-green-600 hover:underline mt-4 inline-block">
