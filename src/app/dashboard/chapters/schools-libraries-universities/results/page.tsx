...
function ResultsContent() {
  ...
  const loadResults = async () => {
    try {
      // Load progress
      const progressResponse = await fetch('/api/chapters/chapter_schools_libraries_universities/progress')
      ...
      const questionsResponse = await fetch(`/api/chapters/chapter_schools_libraries_universities/questions?${queryParams.toString()}`)
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50">
      ...
      <main className="px-4 py-6 max-w-4xl mx-auto pb-24">
        ...
        <div className="flex gap-4">
          ...
          <Link
            href="/dashboard/chapters/schools-libraries-universities/quiz"
