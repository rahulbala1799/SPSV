...
const CHAPTER_ID = 'chapter_industry_part3'
const CHAPTER_PATH = 'industry-part3'
const CHAPTER_TITLE = 'Industry Knowledge - Part 3'
...
export default function IndustryPart3AnalyticsPage() {
