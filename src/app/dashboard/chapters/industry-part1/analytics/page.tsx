...
const CHAPTER_ID = 'chapter_industry_part1'
const CHAPTER_PATH = 'industry-part1'
const CHAPTER_TITLE = 'Industry Knowledge - Part 1'
...
export default function IndustryPart1AnalyticsPage() {
