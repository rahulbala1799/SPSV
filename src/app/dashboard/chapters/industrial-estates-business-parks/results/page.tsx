...
const CHAPTER_ID = 'chapter_industrial_estates_business_parks'
const CHAPTER_PATH = 'industrial-estates-business-parks'
const CHAPTER_TITLE = 'Industrial Estates & Business Parks'
...
export default function IndustrialEstatesBusinessParksResultsPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-green-600"></div>
